...
func GlobToString(e *Elem) string {
	if e.Type == "glob" {
...
func GlobFromString(d string) *Elem {
...
func GlobCompare(e1 *Elem, e2 *Elem) int {
...
func RegisterGlob() {
	RegisterType("glob", GlobToString, GlobFromString, GlobCompare, GlobDup)
}
